...
class dropSeats extends StatefulWidget {
  final void Function(String?) onActivitySelected;

  const dropSeats({Key? key, required this.onActivitySelected})
      : super(key: key);

  @override
  State<dropSeats> createState() => _ActivityPickerExampleState();
}

class _ActivityPickerExampleState extends State<dropSeats> {
